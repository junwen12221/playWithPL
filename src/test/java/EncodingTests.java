...
public class EncodingTests {
    ...
    private static final TestRecord GERMAN = new TestRecord( "Entwickeln Sie mit Vergnügen", Charset.forName("ISO-8859-1") );
    private static final TestRecord RUSSIAN = new TestRecord( "Разрабатывайте с удовольствием", Charset.forName("Windows-1251") );
    private static final TestRecord JAPANESE = new TestRecord( "喜びと発展", Charset.forName("Shift_JIS") );
    private static final TestRecord TRADITIONAL_CHINESE = new TestRecord( "愉快地發展", Charset.forName("GB18030") );

    private static final TestRecord[] m_data = { ENGLISH, GERMAN,  RUSSIAN, JAPANESE, TRADITIONAL_CHINESE };
    private static final Charset UTF8 = Charset.forName( "UTF-8" );

    private static final Charset[] ASCII_ENCODINGS = { ENGLISH.charset, GERMAN.charset, UTF8 };
